...
type TerminalKillProcessRequest = terminal.KillProcessRequest
type TerminalKillProcessResponse = terminal.KillProcessResponse
...
type SetActiveWorkspaceRequest = terminal.SetActiveWorkspaceRequest
type SetActiveWorkspaceResponse = terminal.SetActiveWorkspaceResponse
